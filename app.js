...
const startApp = async () => {
  ...
  try {
    ...
    if(options.watermarkType === 'Text watermark') {
      ...
      addTextWatermarkToImage('./img/' +file.inputImage, prepareOutputFilename(file.inputImage), options.watermarkText);
    }
    else {
      ...
      addImageWatermarkToImage('./img/' + file.inputImage, prepareOutputFilename(file.inputImage), './img/' + options.watermarkImage);
    }
  } 
  catch (error) {
